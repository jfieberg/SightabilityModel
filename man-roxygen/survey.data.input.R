...
#' @param stratum.data A data fraem containing for each stratum, the stratum id (see stratum.var), the total
#'    number of blocks in the stratum (see stratum.blocks.var) and the total area of the stratum (see stratum.area.var)
#' @param density,abundance,numerator,denominator Right-handed formula indentifying the variable(s) in the
