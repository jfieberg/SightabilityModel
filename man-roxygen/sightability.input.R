#' @param sight.formula A formula that idenfies the model used
#'   to estimate sightablity. For example \code{observed ~ VegCoverClass} would indicate
...
#' @param sight.beta The vector of estimated cofficients for the logistic regression sightability model.
