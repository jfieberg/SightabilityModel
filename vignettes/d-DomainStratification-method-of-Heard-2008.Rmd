...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, out.width="100%"}
...
inflate.density <- plyr::summarize(bootres.final,
        ...
        mean.se      =mean(SE),
        se.inflate   = ifelse(is.finite(sd.estimate / mean.se), sd.estimate / mean.se, 1))
#inflate.density
...
temp <- merge(temp, inflate.se.domain.strat.SCF[,c("Stratum.Domain","se.inflate")])
temp$SE.adj.SCF.ds  <- temp$SE.adj.scf * temp$se.inflate
